...
struct OtherAppsView: View {
    ...
    private let promotionalApps: [AppPromoData] = [
        AppPromoData(
            appName: "Ayura",
            description: "Ayura is your AI-powered coach for smarter nutrition, Ayurveda, and training. It combines nutrition science with practical tools to help you plan meals, design workouts, manage your pantry, and understand how food and movement affect your body.",
            iconName: "AyuraIcon",
            systemImageFallback: "carrot.fill",
            appStoreURL: "https://apps.apple.com/app/id6751406823",
            accentColor: .green
        ),
        AppPromoData(
