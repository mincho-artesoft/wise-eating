...
""",
    ...
    def test_prebuilt_index_matches_v8_global_fallback_projection(self):
        ...
        self.assertEqual((version, food_count), (9, 14_477))
        ...
        self.assertEqual(len(actual_index), 445)
        self.assertEqual(sum(map(len, expected_index.values())), 128_348)
    ...
    def test_runtime_paths_keep_the_global_estimated_fallback(self):
        ...
        self.assertIn(
            "public func estimated(category: String?, name: String)",
            rules,
        )
